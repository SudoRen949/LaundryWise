const Motto = () =>
{
	return (
		<>
			...
			<p className="lead text-white mt-3 fs-2" style={{textShadow:"2px 2px 2px black"}}>
				<i><b>
				...
				<br/><br/>
				<i><b>
					Limited only for residents and laundry owners from Osmena, Agora, and Cagayan de Oro.
				</b></i>
			</p>
		</>
	)
